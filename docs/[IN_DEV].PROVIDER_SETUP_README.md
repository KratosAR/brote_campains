...
**Estado del documento:** 🚧 EN DESARROLLO — Índice de la serie PROVIDER_SETUP_*; Email/SMS listados como '🔄 Ready', no live.
...
### 📖 For End Users
→ **[[IN_DEV].PROVIDER_SETUP_QUICK_START.md](./[IN_DEV].PROVIDER_SETUP_QUICK_START.md)**
- Step-by-step setup for Meta WhatsApp, Evolution, SMTP, Twilio
- Credential gathering
- Troubleshooting

### 🎯 For Product/Design
→ **[[IN_DEV].PROVIDER_SETUP_FLOW.md](./[IN_DEV].PROVIDER_SETUP_FLOW.md)**
...
→ **[[IN_DEV].PROVIDER_SETUP_FRONTEND_GUIDE.md](./[IN_DEV].PROVIDER_SETUP_FRONTEND_GUIDE.md)**
...
|---------|----------|--------|------|
| **WhatsApp** | Meta Business API | ✅ Live | [Setup](./[IN_DEV].PROVIDER_SETUP_QUICK_START.md#whatsapp-meta) |
| | Evolution (Baileys) | ✅ Live | [Setup](./[IN_DEV].PROVIDER_SETUP_QUICK_START.md#whatsapp-evolution--open-source) |
| **Email** | SMTP (Gmail, Outlook, etc) | 🔄 Ready | [Setup](./[IN_DEV].PROVIDER_SETUP_QUICK_START.md#email-smtp) |
| **SMS** | Twilio | 🔄 Ready | [Setup](./[IN_DEV].PROVIDER_SETUP_QUICK_START.md#sms-twilio) |
...
See [[IN_DEV].PROVIDER_SETUP_QUICK_START.md - Troubleshooting](./[IN_DEV].PROVIDER_SETUP_QUICK_START.md#%EF%B8%8F-troubleshooting)
...
1. Read [[IN_DEV].PROVIDER_SETUP_FRONTEND_GUIDE.md](./[IN_DEV].PROVIDER_SETUP_FRONTEND_GUIDE.md)
...
- Backend API: See [[IN_DEV].PROVIDER_SETUP_FLOW.md](./[IN_DEV].PROVIDER_SETUP_FLOW.md#api-endpoints-already-exist--to-build)
- User Setup: See [[IN_DEV].PROVIDER_SETUP_QUICK_START.md](./[IN_DEV].PROVIDER_SETUP_QUICK_START.md)
- Frontend Code: See [[IN_DEV].PROVIDER_SETUP_FRONTEND_GUIDE.md](./[IN_DEV].PROVIDER_SETUP_FRONTEND_GUIDE.md)
