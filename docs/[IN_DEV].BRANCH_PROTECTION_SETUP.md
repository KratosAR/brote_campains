...
**Estado del documento:** 🚧 EN DESARROLLO — Checklist de configuración con pasos pendientes en GitHub.
...
- [[CURRENT].CI_CD_RULES.md](./[CURRENT].CI_CD_RULES.md) — Policy for all CI/CD gates
