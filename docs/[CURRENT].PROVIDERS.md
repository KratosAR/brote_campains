...
**Estado del documento:** 📌 VIGENTE (documento de referencia continuo) — Documentación viva de arquitectura de providers.
...
- BCP Architecture: [../[CURRENT].PROVIDERS.md](../[CURRENT].PROVIDERS.md)
