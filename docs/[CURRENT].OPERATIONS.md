...
**Estado del documento:** 📌 VIGENTE (documento de referencia continuo) — Guía operativa vigente.
...
Ver [`docs/[CURRENT].PROVIDERS.md`](./[CURRENT].PROVIDERS.md) para documentación completa.
